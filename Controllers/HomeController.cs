    ...
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            var model = new HomeViewModel
            {
                ...
                // ---- Category pills ----
                CategoryPills = new CategoryPillsViewModel
                {
                ...
                // ---- Featured products ----
                FeaturedProducts = new List<ProductCardViewModel>
                {
                ...
                // ---- Flash sale ----
                FlashSale = new FlashSaleViewModel
                {
                ...
                // ---- Top rated ----
                TopRatedProducts = new List<RatedProductViewModel>
                {
            ...
            ViewBag.CartCount = 3; // replace with session/DB value
        ...
        public ActionResult Journal() => View();
    }
}